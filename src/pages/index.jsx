  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gradient-to-br from-primary-600 via-primary-700 to-primary-900 dark:from-neutral-900 dark:via-neutral-800 dark:to-neutral-900 transition-colors duration-300">
        {/* Navbar */}
        <nav className="bg-white/10 dark:bg-neutral-900/50 backdrop-blur-sm">
          <div className="container mx-auto px-4 py-4 flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Link
                href="/auth/registro"
                className="bg-white dark:bg-neutral-700 text-primary-700 dark:text-neutral-100 px-4 py-2 rounded-lg font-semibold hover:bg-white/90 dark:hover:bg-neutral-600 transition-colors"
              >
                Registrarse
              </Link>
            </div>
        ...
        <div className="container mx-auto px-4 py-16">
          ...
          <section className="text-center py-16">
            ...
            <p className="text-xl text-white/80 dark:text-neutral-300 mb-8 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/auth/registro"
                className="bg-white dark:bg-neutral-100 text-primary-700 dark:text-primary-800 text-lg px-8 py-4 rounded-xl font-bold hover:bg-white/90 dark:hover:bg-neutral-200 transition-all transform hover:scale-105 shadow-lg"
              >
                Comenzar Ahora
              </Link>
              <Link
                href="/auth/login"
                className="bg-white/20 dark:bg-neutral-700/50 text-white text-lg px-8 py-4 rounded-xl font-bold hover:bg-white/30 dark:hover:bg-neutral-700 transition-all border-2 border-white/50 dark:border-neutral-600"
              >
                Ya tengo cuenta
              </Link>
            </div>
          ...
          <section className="py-12">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white dark:bg-neutral-800 rounded-2xl p-8 text-center shadow-xl dark:shadow-neutral-900/50 transform hover:scale-105 transition-all">
                <div className="w-20 h-20 bg-primary-100 dark:bg-primary-900/30 rounded-full flex items-center justify-center mx-auto mb-4">
                  <Icons.User className="w-10 h-10 text-primary-600 dark:text-primary-400" />
                </div>
              ...
              <div className="bg-white dark:bg-neutral-800 rounded-2xl p-8 text-center shadow-xl dark:shadow-neutral-900/50 transform hover:scale-105 transition-all">
                <div className="w-20 h-20 bg-secondary-100 dark:bg-secondary-900/30 rounded-full flex items-center justify-center mx-auto mb-4">
                  <Icons.Building className="w-10 h-10 text-secondary-600 dark:text-secondary-400" />
                </div>
                <h3 className="text-xl font-bold text-neutral-800 dark:text-neutral-100 mb-2">
                  Depósitos
                </h3>
              ...
              <div className="bg-white dark:bg-neutral-800 rounded-2xl p-8 text-center shadow-xl dark:shadow-neutral-900/50 transform hover:scale-105 transition-all">
                <div className="w-20 h-20 bg-accent-100 dark:bg-accent-900/30 rounded-full flex items-center justify-center mx-auto mb-4">
                  <Icons.Truck className="w-10 h-10 text-accent-600 dark:text-accent-400" />
                </div>
                <h3 className="text-xl font-bold text-neutral-800 dark:text-neutral-100 mb-2">
                  Transportistas
                </h3>
          ...
          <section className="py-12 text-center">
            <div className="bg-white/10 dark:bg-neutral-800/50 backdrop-blur-sm rounded-2xl p-12">
              <h2 className="text-3xl font-bold text-white mb-4">
                ¿Listo para comenzar?
              </h2>
              <p className="text-white/80 dark:text-neutral-300 mb-8 max-w-xl mx-auto">
                Regístrate ahora y comienza a gestionar tus repartos de manera
                profesional.
              </p>
              <Link
                href="/auth/registro"
                className="inline-block bg-white dark:bg-neutral-100 text-primary-700 dark:text-primary-800 text-lg px-10 py-4 rounded-xl font-bold hover:bg-white/90 dark:hover:bg-neutral-200 transition-all shadow-lg"
              >
                Crear mi cuenta →
              </Link>
            </div>
        ...
        {/* Footer */}
        <footer className="bg-black/20 dark:bg-neutral-900/50 py-6">
          <div className="container mx-auto px-4 text-center text-white/60 dark:text-neutral-500">
